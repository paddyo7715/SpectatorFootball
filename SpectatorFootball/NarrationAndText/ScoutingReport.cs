...
namespace SpectatorFootball.NarrationAndText
{
    class ScoutingReport
    {
        ...
        public static string SpeedReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Weak = new List<string>() { "a very slow runner", "not a fast runner at all", "does not poses speed at all" };
        ...
        public static string AgilityReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Weak = new List<string>() { "very poor agility", "not an agile runner at all", "does not poses agility at all" };
        ...
        public static string RunBlockingReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Excellent = new List<string>() { "poses great run blocking skill", "exceptional run blocker", "has elite run blocking ability", "extrememly good run blocker", "poses elite run blocking ability" };
            List<string> adj_Good = new List<string>() { "poses good run blocking skill", "better than average run blocker", "good at blocking run rushers" };
            List<string> adj_Average = new List<string>() { "is an average run blocker", "poses average run blocking ability", "ordinary run blocker", "run of the mill run blocker" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses good or even average ball run blocking ability", "below average run blocker", "does not have even average run blocking ability", "less than average run blocker" };
            List<string> adj_Weak = new List<string>() { "very poor run blocker", "does not have good run blocking ability at all", "does not poses much ability to block run rushers" };
        ...
        public static string PassRushingReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Excellent = new List<string>() { "poses great pass rushing skill", "exceptional pass rusher", "has elite pass rushing ability", "extrememly good pass rusher", "poses elite pass rushing ability", "can really get to the QB" };
            List<string> adj_Good = new List<string>() { "poses good pass rushing skill", "better than average pass rusher", "good at rushing the passer" };
            List<string> adj_Average = new List<string>() { "is an average pass rusher", "poses average pass rushing ability", "ordinary pass rusher", "run of the mill pass rusher" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses good or even average pass rushing ability", "below average pass rusher", "does not have even average pass rushing ability", "less than average pass rusher" };
            List<string> adj_Weak = new List<string>() { "very poor pass rusher", "does not have good pass rushing ability at all", "does not poses much ability to rush the passer" };
        ...
        public static string RunStoppingReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Excellent = new List<string>() { "poses great run stopping skill", "exceptional run stopper", "has elite run stopping ability", "extrememly good run stopper", "poses elite run stopping ability", "can really stuff the run" };
            List<string> adj_Good = new List<string>() { "poses good run stopping skill", "better than average run stopper", "good at stopping the run" };
            List<string> adj_Average = new List<string>() { "is an average run stopper", "poses average run stopping ability", "ordinary run stopper", "run of the mill run stopper" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses good or even average run stopping ability", "below average run stopper", "does not have even average run stopping ability", "less than average run stopper" };
            List<string> adj_Weak = new List<string>() { "very poor run stopper", "does not have good run stopping ability at all", "does not poses much ability to stop the run" };
        ...
        public static string TackleReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Excellent = new List<string>() { "poses great tackling skill", "exceptional tackler", "has elite tackling ability", "extrememly good tackler", "poses elite tackling ability", "can really bring ball carriers down" };
            List<string> adj_Good = new List<string>() { "poses good tackloing skill", "better than average tackler", "good at tackling" };
            List<string> adj_Average = new List<string>() { "is an average tackler", "poses average tackling ability", "ordinary tackler", "run of the mill tackler" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses good or even average tackling ability", "below average tackler", "has below average tackling ability", "less than average tackler" };
            List<string> adj_Weak = new List<string>() { "very poor tackler", "does not have good tackling ability at all", "does not poses much ability to tackle ball carriers" };
        ...
        public static string LegPowerReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Average = new List<string>() { "average leg strength", "poses average leg strength", "ordinary leg strength", "run of the mill leg strength" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses a strong kicking leg", "below average leg strength", "has below average leg strength", "less than average leg strength" };
            List<string> adj_Weak = new List<string>() { "very poor leg strength", "does not have good leg strength at all", "does not poses much leg strength" };
        ...
        public static string LegAccuracyKReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Average = new List<string>() { "average leg accuracy", "poses average accuracy", "ordinary accuracy", "run of the mill leg accuracy" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses an accurate kicking leg", "below average accuracy", "has below average accuracy", "less than average accuracy" };
            List<string> adj_Weak = new List<string>() { "very poor accuracy", "does not have good accuracy at all", "does not poses much kicking accuracy" };
        ...
        public static string LegAccuracyPReport(int value, int lowerR, int upperR, bool bFirst, bool bLast)
        {
            ...
            List<string> adj_Average = new List<string>() { "average ability with coffin corner punts", "poses average ability to pin team inside the 5 yard line with punts", "ordinary coffin corner punts", "run of the mill coffin corner accuracy" };
            List<string> adj_BelowAverage = new List<string>() { "does not poses average coffin corner punt ability", "below average coffin corner accuracy", "has below average coffin corner punts", "less than average ability to pin teams inside 5 yard line" };
            List<string> adj_Weak = new List<string>() { "very poor coffin corner punting ability", "does not have good coffin corner punt ability at all", "does not poses much coffin corner accuracy" };
