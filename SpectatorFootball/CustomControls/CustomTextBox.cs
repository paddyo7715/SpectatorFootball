...
namespace SpectatorFootball.CustomControls
{
    class CustomTextBox : WpfTextBox
    {
        ...
        {
            if (DependencyPropertyHelper.GetValueSource(this, CustomTextBox.HorizontalContentAlignmentProperty).BaseValueSource == BaseValueSource.Local
                && DependencyPropertyHelper.GetValueSource(this, CustomTextBox.TextAlignmentProperty).BaseValueSource != BaseValueSource.Local)
            {
