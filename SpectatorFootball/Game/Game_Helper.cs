        ...
        public static Formation getFormation(Formations_Enum fe, double PossessionAdjuster)
        {
            ...
            switch (fe)
            {
                case Formations_Enum.KICKOFF_REGULAR_KICK:
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.LB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 62, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 68, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 74, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 80, State = Player_States.STANDING });
                    break;
                ...
                case Formations_Enum.KICKOFF_ONSIDE_KICK:
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.TE, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 32, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 38, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 44, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.K, YardLine = (-7.0 * PossessionAdjuster), Vertical_Percent_Pos = 49, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 56, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.RB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 62, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 68, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 74, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-1.0 * PossessionAdjuster), Vertical_Percent_Pos = 80, State = Player_States.STANDING });
                    break;
                case Formations_Enum.KICKOFF_ONSIDE_RECEIVE:
                    ...
                    f.f_enum = fe;
                    f.bSpecialTeams = true;
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.RB, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 20, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.TE, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 27, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 32, State = Player_States.STANDING });
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 55, State = Player_States.STANDING });
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 68, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.TE, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 73, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.RB, YardLine = (10.0 * PossessionAdjuster), Vertical_Percent_Pos = 80, State = Player_States.STANDING });
                    break;
                case Formations_Enum.PUNT:
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (-2.5 * PossessionAdjuster), Vertical_Percent_Pos = 42, State = Player_States.STANDING });
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.TE, YardLine = (-4.0 * PossessionAdjuster), Vertical_Percent_Pos = 54, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.RB, YardLine = (-2.0 * PossessionAdjuster), Vertical_Percent_Pos = 59, State = Player_States.STANDING });
                ...
                case Formations_Enum.PUNT_RETURN:
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.LB, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 38, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DL, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 43, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DL, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 48, State = Player_States.STANDING });
                    ...
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DL, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 52, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DL, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 57, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.LB, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 62, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.LB, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 67, State = Player_States.STANDING });
                    f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (1.0 * PossessionAdjuster), Vertical_Percent_Pos = 77, State = Player_States.STANDING });
                    break;
            }
            return f;
        }
