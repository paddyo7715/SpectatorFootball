...
{
    public class Kickoff_Free_Kick_Formation : iFormation_Play
    {
        public Formation getFormation(Formations_Enum fe, double PossessionAdjuster)
        {
            ...
            f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.P, YardLine = (-8.0 * PossessionAdjuster), Vertical_Percent_Pos = 49, State = Player_States.STANDING });
