...
{
    public class Kickoff_Free_Kick_Return_Formation : iFormation_Play
    {
        public Formation getFormation(Formations_Enum fe, double PossessionAdjuster)
        {
            ...
            f.Name = "Kickoff_Free_Kick_Receive";
            f.f_enum = fe;
            ...
            f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (30.0 * PossessionAdjuster), Vertical_Percent_Pos = 35, State = Player_States.STANDING });
            ...
            f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.WR, YardLine = (40.0 * PossessionAdjuster), Vertical_Percent_Pos = 50, State = Player_States.STANDING });
            ...
            f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.DB, YardLine = (30.0 * PossessionAdjuster), Vertical_Percent_Pos = 65, State = Player_States.STANDING });
