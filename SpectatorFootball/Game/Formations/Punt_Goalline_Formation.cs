...
{
    public class Punt_Goalline_Formation : iFormation_Play
    {
        public Formation getFormation(Formations_Enum fe, double PossessionAdjuster)
        {
            ...
            f.KickerIndex = 5;
            f.Punter_Behind_Line_ayrds = 9.0;
            ...
            f.Player_list.Add(new Formation_Rec() { Pos = Enum.Player_Pos.P, YardLine = (-9.0 * PossessionAdjuster), Vertical_Percent_Pos = 49, State = Player_States.STANDING });
