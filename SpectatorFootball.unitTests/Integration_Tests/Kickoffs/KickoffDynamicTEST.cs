...
{
    [TestClass]
    public class KickoffDynamicTEST
    {
        ...
        public void Normal_Kickoff_Avgs()
        {
            ...
            for (int i = 0; i < num_plays; i++)
            {
                ...
                Formation KickForm = formation_helper.getFormation(Formations_Enum.KICKOFF_DYNAMIC_KICK, PossessionAdjuster);
                Formation RecForm = formation_helper.getFormation(Formations_Enum.KICKOFF_DYNAMIC_RECEIVE, PossessionAdjuster);
            ...
            // 33% of kickoffs should be returned
            // 27 yards average return.
            // 10 TDs for every 1000 returns
