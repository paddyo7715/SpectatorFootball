...
{
    [TestClass]
    public class PuntGoalLineTEST
    {
        [TestCategory("Integration")]
        [TestMethod]
        public void Punt_GoadLine()
        {
            ...
            for (int i = 0; i < num_plays; i++)
            {
                ...
                if (bLefttoRight)
                {
                    ...
                    if (!pResult.bFumble_Lost && pResult.bTouchDown) L_num_TDs++;
                ...
                else
                {
                    ...
                    if (!pResult.bFumble_Lost && pResult.bTouchDown) R_num_TDs++;
                    ...
                    if (pResult.bTouchDown && pResult.bFumble_Lost) R_TD_Fumble++;
            ...
            if (R_Defender_close_toKicker < 300 || R_Defender_close_toKicker > 900)
