...
namespace SpectatorFootball.unitTests.Unit_Tests.Game_PlayerTest
{
    ...
    public class Game_PlayerTEST
    {
        ...
        public void getReturnerAction_OutofBounds_Top_Left()
        {
            ...
            var t = gp.getReturnerAction(50.0, -1.0, false, 50, true);
        ...
        public void getReturnerAction_OutofBounds_Bottum_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(50.0, 101.0, false, 50, true);
        ...
        public void getReturnerAction_OutofEndZone_Bottum_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(111.0, 51.0, false, 50, true);
        ...
        public void getReturnerAction_DontField_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(96.0, 51.0, false, 53, true);
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void getReturnerAction_Return_close_to_goalLine_Left()
        {
            Game_Player gp = Help_Class.getPunter(11);
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void getReturnerAction_inEndZone_Return_Left()
        {
            Game_Player gp = Help_Class.getPunter(11);
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
        ...
        public void getReturnerAction_lastPlay_inEndZone_Return_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(105.0, 51.0, true, 10, true);
        ...
        public void getReturnerAction_inEndZone_Kneel_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(105.0, 51.0, false, 10, true);
        ...
        public void getReturnerAction_Regular_Return_Left()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(80.0, 51.0, false, 10, true);
        ...
        public void getReturnerAction_OutofBounds_Top_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(50.0, -1.0, false, 50, false);
        ...
        public void getReturnerAction_OutofBounds_Bottum_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(50.0, 101.0, false, 50, false);
        ...
        public void getReturnerAction_OutofEndZone_Bottum_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(-11.0, 51.0, false, 50, false);
        ...
        public void getReturnerAction_DontField_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(4.0, 51.0, false, 53, false);
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void getReturnerAction_Return_close_to_goalLine_Right()
        {
            Game_Player gp = Help_Class.getPunter(11);
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void getReturnerAction_inEndZone_Return_Right()
        {
            Game_Player gp = Help_Class.getPunter(11);
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
        ...
        public void getReturnerAction_lastPlay_inEndZone_Return_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(-5.0, 51.0, true, 10, false);
        ...
        public void getReturnerAction_inEndZone_Kneel_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(-5.0, 51.0, false, 10, false);
        ...
        public void getReturnerAction_Regular_Return_Right()
        {
            ...
            Player_Ratings pr = gp.p_and_r.pr.First();
            pr.Decision_Making_Rating = 40;
            var t = gp.getReturnerAction(20.0, 51.0, false, 10, false);
