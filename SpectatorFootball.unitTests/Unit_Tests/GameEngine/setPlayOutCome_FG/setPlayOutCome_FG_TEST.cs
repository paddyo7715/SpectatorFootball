...
namespace SpectatorFootball.unitTests.GameEngineNS
{
    ...
    public class setPlayOutCome_FG_TEST
    {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void setPlayOutCome_FG_Left_Not_Good_No_Penalty_Inside_20()
        {
            bool penOnBallCarryingTeam = false;
            Play_Enum PE = Play_Enum.FIELD_GOAL;
            int Down = 4;
            ...
            Play_Result pResult = new Play_Result()
            {
                ...
                BallPossessing_Team_Id = 11,
                NonbBallPossessing_Team_Id = 22,
                end_of_play_yardline = 98.0,
                Play_Start_Yardline = 98.0,
                Field_Goal_Ball_Spot = 90.0,
                Penalty = Penalty,
                Penalized_Player = Penalized_Player,
                Kicker = kicker,
                bPenalty_Rejected = false,
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void setPlayOutCome_FG_Rightt_Not_Good_No_Penalty_Inside_20()
        {
            bool penOnBallCarryingTeam = false;
            Play_Enum PE = Play_Enum.FIELD_GOAL;
            int Down = 4;
            ...
            Play_Result pResult = new Play_Result()
            {
                ...
                Play_Start_Yardline = 2.0,
                Field_Goal_Ball_Spot = 10.0,
                Penalty = Penalty,
                Penalized_Player = Penalized_Player,
                Kicker = kicker,
                bPenalty_Rejected = false,
