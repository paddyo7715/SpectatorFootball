...
namespace SpectatorFootball.unitTests.GameEngineNS
{
    ...
    public class GameEngineTEST
    {
        ...
        [TestCategory("GameEngine")]
        [TestMethod]
        public void setPlayOutCome_NomralKickoff_Left_ReturntoOwn20_Spot_Penalty_on_Returners_to_30()
        {
            bool penOnBallCarryingTeam = false;
            Play_Enum PE = Play_Enum.KICKOFF_NORMAL;
            int Down = 0;
        ...
        [TestCategory("GameEngine")]
        [TestMethod]
        public void setPlayOutCome_NomralKickoff_Left_ReturntoOwn07_Spot_Penalty_on_Returners_to_08()
        {
            bool penOnBallCarryingTeam = false;
            Play_Enum PE = Play_Enum.KICKOFF_NORMAL;
            int Down = 0;
        ...
        [TestCategory("GameEngine")]
        [TestMethod]
        public void setPlayOutCome_NomralKickoff_Left_ReturntoOwn92_Spot_Penalty_on_Returners_to_92()
        {
            bool penOnBallCarryingTeam = false;
            Play_Enum PE = Play_Enum.KICKOFF_NORMAL;
            int Down = 0;
